...
describe('User Route', function() {
    ...
    it('Update User One Empty', function(done) {
        request
            .put('/routes/users/' + config.get('userOne'))
            .set('Accept', 'application/json')
    ...
    it('Update User Two Empty', function(done) {
        request
            .put('/routes/users/' + config.get('userTwo'))
            .set('Accept', 'application/json')
            // uncomment for jwt authentication
    ...
    it('Update User Three Empty', function(done) {
        request
            .put('/routes/users/' + config.get('userThree'))
            .set('Accept', 'application/json')
            // uncomment for jwt authentication
    ...
    it('Login User One', function(done) {
        request
            .put('/routes/users/' + config.get('userOne') + '/login')
            .set('Accept', 'application/json')
            .set('Content-Type', 'application/x-server.js-form-urlencoded')
            .send({
                _id: config.get('userOne'),
    ...
    it('Login User Two', function(done) {
        request
            .put('/routes/users/' + config.get('userTwo') + '/login')
            .set('Accept', 'application/json')
            .set('Content-Type', 'application/x-server.js-form-urlencoded')
            .send({
                _id: config.get('userTwo'),
    ...
    it('Login User Three', function(done) {
        request
            .put('/routes/users/' + config.get('userThree') + '/login')
            .set('Accept', 'application/json')
            .set('Content-Type', 'application/x-server.js-form-urlencoded')
            .send({
                _id: config.get('userThree'),
    ...
    it('Find User One', function(done) {
        request
            .get('/routes/users/' + config.get('userOne'))
            .set('Accept', 'application/json')
            // uncomment for jwt authentication
            // .set('Authorization', 'JWT ' + global.userOneJwt)
            .set('Content-Type', 'application/x-server.js-form-urlencoded')
    ...
    it('Find User Two', function(done) {
        request
            .get('/routes/users/' + config.get('userTwo'))
            .set('Accept', 'application/json')
            // uncomment for jwt authentication
            // .set('Authorization', 'JWT ' + global.userTwoJwt)
            .set('Content-Type', 'application/x-server.js-form-urlencoded')
    ...
    it('Find User Three', function(done) {
        request
            .get('/routes/users/' + config.get('userThree'))
            .set('Accept', 'application/json')
            // uncomment for jwt authentication
            // .set('Authorization', 'JWT ' + global.userThreeJwt)
            .set('Content-Type', 'application/x-server.js-form-urlencoded')
    ...
    it('Delete User One', function(done) {
        request
            .delete('/routes/users/' + config.get('userOne'))
            .set('Accept', 'application/json')
            // uncomment for jwt authentication
            // .set('Authorization', 'JWT ' + global.userOneJwt)
            .set('Content-Type', 'application/x-server.js-form-urlencoded')
    ...
    it('Delete User Two', function(done) {
        request
            .delete('/routes/users/' + config.get('userTwo'))
            .set('Accept', 'application/json')
            // uncomment for jwt authentication
            // .set('Authorization', 'JWT ' + global.userTwoJwt)
            .set('Content-Type', 'application/x-server.js-form-urlencoded')
    ...
    it('Delete User Three', function(done) {
        request
            .delete('/routes/users/' + config.get('userThree'))
            .set('Accept', 'application/json')
            // uncomment for jwt authentication
            // .set('Authorization', 'JWT ' + global.userThreeJwt)
            .set('Content-Type', 'application/x-server.js-form-urlencoded')
